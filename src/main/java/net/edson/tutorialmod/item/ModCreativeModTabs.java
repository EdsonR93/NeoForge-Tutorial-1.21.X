package net.edson.tutorialmod.item;

import net.edson.tutorialmod.TutorialMod;
...
public class ModCreativeModTabs {
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_ITEMS_TAB = CREATIVE_MODE_TAB.register("bismuth_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BISMUTH.get()))
                    .title(Component.translatable("creative.tutorialmod.bismuth_items"))
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_BLOCK_TAB = CREATIVE_MODE_TAB.register("bismuth_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.BISMUTH_BLOCK.get()))
                    ...
                    .title(Component.translatable("creative.tutorialmod.bismuth_blocks"))
                    .displayItems((itemDisplayParameters, output) -> {
